...
export const BOM: BomItem[] = [
  ...
  // ── FIRE ALARM DEVICES ────────────────────────────────────────────────────
  { id:'fad1',  cat:'Fire Alarm', name:'FL Pull Station',                      unit:'EA', mat:55.00,   lhr:0.35, mk:'bulk' },
  { id:'fad2',  cat:'Fire Alarm', name:'FL Smoke Detector',                    unit:'EA', mat:100.00,  lhr:0.35, mk:'bulk' },
  { id:'fad3',  cat:'Fire Alarm', name:'FL Heat Detector',                     unit:'EA', mat:100.00,  lhr:0.35, mk:'bulk' },
  { id:'fad4',  cat:'Fire Alarm', name:'FL Smoke/CO Combo',                    unit:'EA', mat:175.00,  lhr:0.45, mk:'bulk' },
  { id:'fad5',  cat:'Fire Alarm', name:'FL Horn/Strobe',                       unit:'EA', mat:100.00,  lhr:0.35, mk:'bulk' },
  { id:'fad6',  cat:'Fire Alarm', name:'FL Strobe',                            unit:'EA', mat:100.00,  lhr:0.35, mk:'bulk' },
  { id:'fad7',  cat:'Fire Alarm', name:'FL LF Sounder',                        unit:'EA', mat:100.00,  lhr:0.35, mk:'bulk' },
  { id:'fad8',  cat:'Fire Alarm', name:'FL Beacon',                            unit:'EA', mat:75.00,   lhr:0.35, mk:'bulk' },
  { id:'fad9',  cat:'Fire Alarm', name:'FL Control/Monitor Module',            unit:'EA', mat:160.00,  lhr:0.45, mk:'bulk' },
  { id:'fad10', cat:'Fire Alarm', name:'FL Duct Smoke Detector',               unit:'EA', mat:250.00,  lhr:0.65, mk:'bulk' },
  { id:'fad11', cat:'Fire Alarm', name:'FL Annunciator',                       unit:'EA', mat:225.00,  lhr:1.00, mk:'bulk' },
  { id:'fad12', cat:'Fire Alarm', name:'FL Control Panel Small (4 ch)',        unit:'EA', mat:650.00,  lhr:3.00, mk:'bulk' },
  { id:'fad13', cat:'Fire Alarm', name:'FL Control Panel Medium (6 ch)',       unit:'EA', mat:650.00,  lhr:4.50, mk:'bulk' },
  { id:'fad14', cat:'Fire Alarm', name:'FL Control Panel Large (10 ch)',       unit:'EA', mat:1300.00, lhr:7.50, mk:'bulk' },
  { id:'fad15', cat:'Fire Alarm', name:'FL Radio Box',                         unit:'EA', mat:500.00,  lhr:1.00, mk:'bulk' },
