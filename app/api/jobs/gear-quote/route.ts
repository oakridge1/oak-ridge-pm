...
export async function POST(req: NextRequest) {
    ...
    <div style="font-family:Arial,sans-serif;max-width:680px;margin:0 auto;">
      ...
      <div style="background:#eff6ff;padding:14px 20px;border:1px solid #bfdbfe;border-top:none;">
        <p style="margin:0;color:#1d4ed8;font-size:14px;">
          Please provide your best unit pricing for the electrical gear listed below.
  ...
  if (FROM && PASS) {
    ...
    await transport.sendMail({
      ...
      to:          vendorEmail,
      cc:          ccList.join(', '),
      subject:     `Gear Quote Request — ${vendorName} — ${jobNumber} ${jobName}`,
      html,
