...
import { getRates, type SavedAssembly } from '@/lib/estimator/constants';
...
function AssemblyRow({
  ...
  function handleAddLine() {
    ...
    addAssemblyLine(groupKey, idx, addName.trim() || 'New Line', mat, hrs * laborRate);
    setAddName(''); setAddMat(''); setAddHrs('');
  }
        ...
        <div className="bg-[#fafbfc] px-6 py-3">
          ...
          <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-200">
            <input
              ...
              className="flex-1 min-w-0 border border-gray-300 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-[#002D72]"
            />
            <input
              type="number"
              placeholder="Mat $"
              ...
              className="w-20 border border-gray-300 rounded px-2 py-1 text-xs text-right font-mono focus:outline-none focus:ring-1 focus:ring-[#002D72]"
            />
            <input
              type="number"
              placeholder="Hrs"
              ...
              className="w-16 border border-gray-300 rounded px-2 py-1 text-xs text-right font-mono focus:outline-none focus:ring-1 focus:ring-[#002D72]"
            />
            <button
              onClick={handleAddLine}
              className="shrink-0 border border-[#002D72] text-[#002D72] rounded px-2 py-1 text-xs font-medium hover:bg-[#002D72] hover:text-white transition-colors"
            >
              + Add Line
            </button>
            {item._edited && (
              <button
                ...
                className="shrink-0 border border-gray-300 text-gray-500 rounded px-2 py-1 text-xs hover:bg-gray-100 transition-colors"
              >
                ↺ Reset
              </button>
            )}
